    ...
    dio.interceptors.add(
      InterceptorsWrapper(
        ...
        onError: (DioException e, handler) async {
          ...
          // Skip auto-logout for auth endpoints (/v1/auth/*) to prevent
          // interference with getMe() checks
          if (statusCode == 401 && !path.contains('/v1/auth')) {
            log('Token expired or invalid on non-auth endpoint, clearing stored token');
